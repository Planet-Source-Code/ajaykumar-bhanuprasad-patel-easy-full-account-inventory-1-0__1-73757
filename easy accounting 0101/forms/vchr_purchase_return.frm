...
Begin VB.Form vchr_purchase_return 
   ...
   ClientTop       =   345
   ClientWidth     =   11760
   Icon            =   "vchr_purchase_return.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8430
   ScaleWidth      =   11760
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox Text4 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   7
         Text            =   "vchr_purchase_return.frx":1D2A
         Top             =   720
         Width           =   3015
      End
...
'If this_entry_is_saved <> 1 Then
    ...
    With rs_inv_tran_sal
        ...
        If grid_stk_dtl.TextMatrix(inventory_sub_entry_no, 10) = "" Then
        !stk_invt_trn_splr = "Unknown supplier"
        Else
        !stk_invt_trn_splr = grid_stk_dtl.TextMatrix(inventory_sub_entry_no, 10)
        End If
        .UpdateBatch
    End With
    Next
...
'            !fin_acnt_trn_nrtn = Text4.Text
            ...
            rs_acn_tran_sal!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_sal!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_sal!fin_acnt_trn_ldgr = "purchase return account" ' combo_lgr(transaction_counter).Text"
            rs_acn_tran_sal!fin_acnt_trn_amnt = lbl_total_amt.Caption ' text_amt(transaction_counter).Text
...
ElseIf keycode_now = 39 Or keycode_now = 13 Then
            ...
            If grid_stk_dtl.Col = 6 Then    'enter on the amount column
                ...
                grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 8) = Format(((Val(grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 7)) - Val(grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 5))) / Val(grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 7))) * 100, "0.00") & "%"
                grid_stk_dtl.Col = 10
                Call move_to_next_row
                'Call next_cmb_inv_vat_type
                'If grid_stk_dtl.Rows = grid_stk_dtl.Row + 1 Then
...
Next
lbl_total_qty1.Caption = "Total Qty......: " & total_qnty
lbl_total_amt1.Caption = "Total Amt......: " & Format(total_amnt, "0.00")
...
lbl_vat_type.Visible = False
cmb_vat_type.Visible = False
'lbl_l_name = "NAME"
'lbl_l_add = "ADDRESS"
...
'open accounting purchase return voucher
...
Next
Call set_selected_ledger_detail
'open inventory purchase return voucher
...
If rs_inv_tran_sal!stk_invt_trn_vcno = selected_voucher_no Then
    With rs_inv_tran_sal
        ...
        grid_stk_dtl.TextMatrix(inventory_sub_entry_no, 10) = !stk_invt_trn_splr
'       !stk_invt_trn_vcno = Text5.Text
'       !stk_invt_trn_date = DTPicker1.Value
'       !stk_invt_trn_time = lbl_time.Caption
'       !stk_invt_trn_wday = lbl_day.Caption
...
Loop
cmb_sales_man.Text = "purchase return under"
End Sub
