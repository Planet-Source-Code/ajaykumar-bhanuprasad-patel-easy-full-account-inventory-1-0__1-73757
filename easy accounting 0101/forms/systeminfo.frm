...
MsgBox sysinfo_c_biosver
MsgBox sysinfo_c_biosman
MsgBox sysinfo_c_sysdrv_serial_no
End Sub
Public Sub sysinfofile_is_available()
   
Call get_system_data
Dim success%
Dim search_file As String
search_file = sysinfo_path
    success% = reg.FileExists%(search_file)

If success% = True Then
    Call open_and_read_system_data
    Call compare_data
