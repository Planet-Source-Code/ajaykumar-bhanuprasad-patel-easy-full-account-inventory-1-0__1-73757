...
Begin VB.Form vchr_sale_return 
   ...
   ClientTop       =   345
   ClientWidth     =   11760
   Icon            =   "vchr_sale_return.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8430
   ScaleWidth      =   11760
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox Text4 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   18
         Text            =   "vchr_sale_return.frx":1D2A
         Top             =   720
         Width           =   3015
      End
...
If rs_acn_tran_prs.RecordCount > 0 Then
    ...
    If rs_acn_tran_prs!fin_acnt_trn_vcno = Text5.Text Then
            ...
            rs_acn_tran_prs!fin_acnt_trn_ldgr = "sale return account" ' combo_lgr(transaction_counter).Text
...
'            !fin_acnt_trn_nrtn = Text4.Text
            ...
            rs_acn_tran_prs!fin_acnt_trn_vchr = "sale return"
